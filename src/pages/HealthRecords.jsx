    ...
    <div className="bg-gray-100">
      <div className="max-w-sm mx-auto bg-white">
        ...
        <div className="flex items-center justify-between bg-gray-50 border border-gray-100 hover:border-gray-200 p-4 mx-3 rounded-lg cursor-pointer">
          <div className="flex justify-center items-center gap-3">
            ...
            <div className="">
              ...
              <p className="text-xs text-gray-500">Access all your health records</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2 mx-3 mt-2 mb-4">
          {[
            { title: "Lab Reports", icon: "", tag: "lab reports" },
            { title: "Prescription", icon: "", tag: "medical records" },
            { title: "Vaccination", icon: "", tag: "vaccination reports" },
            { title: "Hospital Bills", icon: "", tag: "medical records" },
            { title: "Insurance", icon: "", tag: "lab reports" },
            { title: "Prescriptionn", icon: "", tag: "medical records" },
          ].map((item) => (
            <div
              key={item.title}
