...
const SexualDisordersPage = () => {
  ...
  const handleDoctorClick = (doctorId, specialty) => {
    ...
    navigate(`/book-appointment/sexual-disorder/doctor/${doctorId}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center">
      <div className="max-w-sm w-full bg-white shadow-md rounded-lg overflow-hidden">
        <Header title="Sexual Disorders" onClick={handleAppointmentClick} />
        <LocationDropdown
          locations={locations}
...
export default SexualDisordersPage;
